...
import { DashboardManagement, ActionItemsPanel } from '../components/dashboard/LazyComponents';
...
const DashboardLayout: React.FC = () => {
  ...
  const [widgetSettings, setWidgetSettings] = useLocalStorage(SETTINGS_STORAGE_KEY, defaultWidgetSettings);
    ...
    <ErrorBoundary>
      <div className="min-h-screen bg-gray-50">
        ...
        <main ref={dashboardRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <Suspense text="Loading dashboard management...">
            <DashboardManagement
          ...
          <Suspense text="Loading action items...">
            <ActionItemsPanel
